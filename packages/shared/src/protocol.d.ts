...
export type CameraToServerMessage = CameraRegisterMessage | CameraOfferMessage | CameraIceCandidateMessage | CameraStatusMessage | PongMessage;
...
export type ViewerToServerMessage = ViewerRegisterMessage | ViewerAnswerMessage | ViewerIceCandidateMessage | ViewerStatusMessage | PongMessage;
...
export type ServerToClientMessage = SessionJoinedMessage | ViewerConnectedMessage | ViewerDisconnectedMessage | RelayOfferMessage | RelayAnswerMessage | RelayIceCandidateMessage | ServerErrorMessage | PingMessage | CameraListUpdateMessage | CameraStatusUpdateMessage;
export type SignalingMessage = CameraToServerMessage | ViewerToServerMessage | ServerToClientMessage;
